...
SOURCE_DIR	:= src
BUILD_DIR	:= build
GUNICORN	:= /.py36-venv/bin/gunicorn
PYTHON		:= /.py36-venv/bin/python3
PIP			:= /.py36-venv/bin/pip3
DEBUG 		:= DEBUG=True
...
flask_bench 					:= bjoern/bench/flask_py36.txt
bottle_bench 					:= bjoern/bench/bottle_py36.txt
falcon_bench 					:= bjoern/bench/falcon_py36.txt
flask_gworker_bench 			:= bjoern/bench/flask_gworker_py36.txt
flask_valgrind			 		:= bjoern/bench/flask_valgrind_py36.mem
flask_callgrind			 		:= bjoern/bench/flask_callgrind_py36.mem
